...
//     const automationSolutionTypes: AutomationSolutionType[] = [
//         { id: 1, name: "Business Process Automation" },
//         { id: 2, name: "Robotic Process Automation (RPA)" },
//         { id: 3, name: "Workflow Automation Systems" },
//         { id: 4, name: "Industrial Automation Solutions" },
//         { id: 5, name: "IT Infrastructure Automation" },
//         { id: 6, name: "Marketing Automation Platforms" }
//     ];
...
//         description: "Reduce operational costs through intelligent process automation and optimization."
//     },
//     {
//         title: "Error Elimination",
//         description: "Eliminate human errors and ensure consistent, accurate results across all processes."
//     }
// ];
...
//         // animated blobs config - Updated colors for Automation theme
//         type Blob = {
//             cx: number;
//             cy: number;
//             rx: number; // radius x
...
//         const blobs: Blob[] = [
//             // large red -> orange blob for automation/energy theme
//             { cx: 0, cy: 0, rx: 260, ry: 180, speed: 0.0005, angle: 0, hue: 15, amp: 80, phase: 0 },
//             // medium blue -> cyan blob for technology theme
//             { cx: 0, cy: 0, rx: 160, ry: 120, speed: 0.0008, angle: Math.PI, hue: 200, amp: 60, phase: 1.3 },
//             // small yellow -> gold highlight for efficiency theme
//             { cx: 0, cy: 0, rx: 110, ry: 80, speed: 0.0012, angle: Math.PI / 2, hue: 50, amp: 40, phase: 2.1 },
//         ];
...
//                                     style={{
//                                         background:
//                                             "linear-gradient(90deg, rgba(239,68,68,1) 0%, rgba(59,130,246,1) 45%, rgba(245,158,11,1) 100%)",
...
//                                 Advanced Automation Solutions for Modern Business Operations.
//                             </p>
//                         </div>
//                     </div>
...
//                             We specialize in comprehensive automation solutions that streamline business processes,
//                             reduce operational costs, and enhance productivity across all industries. Our expert team
//                             designs and implements intelligent automation systems using cutting-edge technologies
//                             including RPA, AI-driven workflows, and industrial automation platforms that transform
//                             manual tasks into efficient, error-free automated processes.
//                         </p>

//                         <p className="text-base sm:text-lg lg:text-xl text-slate-600 dark:text-slate-300 leading-relaxed max-w-none">
//                             From simple task automation to complex enterprise-wide process orchestration, we deliver
//                             scalable solutions that integrate seamlessly with existing systems. Our automation expertise
//                             covers business process automation, robotic process automation, workflow management, and
//                             industrial control systems, ensuring maximum efficiency, accuracy, and ROI for your organization.
//                         </p>
//                     </div>
//                 </div>
//             </div>
...
//                         Our Automation Solution Services
//                     </h1>
//                 </div>
...
//                     {automationSolutionTypes.map((service) => (

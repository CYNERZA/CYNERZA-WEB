      ...
      <div className="container mx-auto px-4">
        ...
        >
          {teamStats.map((stat, index) => (
            <div key={index} className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow text-center">
              <div className="text-3xl font-bold text-cynerza-purple mb-2">{stat.value}</div>
            ...
            >
              <div className="bg-white rounded-xl shadow-md overflow-hidden h-full flex flex-col transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <p className="text-cynerza-purple font-medium mb-3">{member.role}</p>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link to="/careers">
              <Button className="bg-cynerza-purple hover:bg-cynerza-purple/90 px-8">
                View Open Positions
              </Button>
            </Link>
            <Link to="/contact">
              <Button variant="outline" className="border-cynerza-purple text-cynerza-purple hover:bg-cynerza-purple/10">
                Contact Our Team
              </Button>
            </Link>
          </div>

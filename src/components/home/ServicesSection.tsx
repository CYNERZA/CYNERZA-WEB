        ...
        <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1  sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, idx) => (
            <motion.div
              ...
              className="relative cursor-pointer rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300 h-80 sm:h-80 md:h-96"
            >
              {/* Full-cover image */}
              <img
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 z-10 w-full" />

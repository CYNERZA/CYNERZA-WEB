...
const SingleBlog: React.FC = () => {
    ...
    return (
        <div className="min-h-screen transition-colors relative">
            ...
            <motion.div className="min-h-screen relative z-10" variants={containerVariants} initial="hidden" animate="visible">
                <motion.div className="sticky top-0 z-30  backdrop-blur-md dark:border-b dark:border-gray-700" variants={itemVariants}>
                    <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
                        <Button variant="ghost" size="sm" onClick={() => navigate('/blogs')} className="hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300">
                            <ArrowLeft className="w-4 h-4 mr-2" /><span className="hidden sm:inline">Back to Stories</span><span className="sm:hidden">Back</span>
                        </Button>
                ...
                <div className="max-w-4xl lg:max-w-5xl xl:max-w-6xl 2xl:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <motion.article variants={itemVariants}>
                        ...
                        <motion.div ref={contentRef} className="prose prose-sm sm:prose-lg lg:prose-xl prose-gray dark:prose-invert max-w-none" variants={itemVariants} style={{ fontSize: `${fontSize}px` }}>
                            <motion.div className=" rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 xl:p-16 shadow-lg sm:shadow-xl border border-gray-200/50 dark:border-gray-700/50" whileInView={{ y: 0, opacity: 1 }} initial={{ y: 30, opacity: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
                                <div className="raw-content leading-relaxed text-gray-800 dark:text-gray-200" dangerouslySetInnerHTML={{ __html: currentBlog.content }} />
                            </motion.div>
                        </motion.div>

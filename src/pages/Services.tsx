...
//                   <span
//                     key={index}
//                     className={`block transition-all duration-1000 ease-in-out ${index === activeService
...
//               <div className="flex flex-wrap gap-3 justify-center lg:justify-start mt-12">
//                 {services.map((service, index) => (
//                   <button
//                     key={index}
//                     onClick={() => setActiveService(index)}
//                     className={`px-4 py-2 rounded-full transition-all ${index === activeService
...
//                   {activeService === 0 && (
//                     <p className="text-xl dark:text-slate-300 text-slate-500 ">
...
//             <div className="lg:w-1/2 w-full h-96 lg:h-[500px] relative">
//               <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/10 to-pink-500/10 rounded-2xl overflow-hidden">
//                 <canvas
//                   ref={canvasRef}
...
//                   <div className="absolute inset-4 bg-gradient-to-br from-indigo-700 to-pink-700 rounded-full shadow-lg"></div>
//                   <div className="absolute inset-8 bg-gradient-to-br from-indigo-800 to-pink-800 rounded-full"></div>
...
//               {/* Floating elements */}
//               <div className="absolute top-10 left-10 w-12 h-12 bg-indigo-500 rounded-full animate-bounce"></div>
//               <div className="absolute bottom-10 right-10 w-16 h-16 bg-pink-500 rounded-full animate-bounce" style={{ animationDelay: '0.2s' }}></div>
//               <div className="absolute top-10 right-10 w-10 h-10 bg-purple-500 rounded-full animate-bounce" style={{ animationDelay: '0.4s' }}></div>
//               <div className="absolute bottom-20 left-20 w-8 h-8 bg-blue-500 rounded-full animate-bounce" style={{ animationDelay: '0.6s' }}></div>
//             </div>
//           </div>

//           {/* Description text that changes with service */}
...
//       <div className='flex flex-col gap-8 max-w-7xl mx-auto py-10 sm:mt-6 '>
//         <h1 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-slate-900 dark:text-slate-200 mb-6 sm:mb-8 font-light'>Champion change through enterprise endurance.</h1>
...
//         </p>
//         <p className='text-slate-900 dark:text-slate-200 text-lg'>
...
//       <div className='max-w-7xl mx-auto py-4 md:py-10  sm:my-8'>
...
//           Our Core Services
//         </h1>
//         <div className="flex flex-col items-center justify-center sm:grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-10 gap-x-12 my-4 py-16">
//           {services.map((s, i) => (
//             <div key={i} className="flex items-center justify-center w-full">
//               <div className="rounded-full p-[2px] transition-all duration-300 bg-gradient-to-r from-cyan-400 to-purple-400 w-full max-w-xs">
//                 <button
//                   onClick={() =>
//                     navigate(`/${s.title
//                       .toLowerCase()
    ...
    <section className='py-2 overflow-hidden'>
      ...
      <div className='flex flex-col gap-6 sm:gap-8 max-w-7xl mx-auto py-8 sm:py-10 lg:py-16 px-4 sm:px-6 lg:px-8'>
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <p className='text-sm sm:text-base lg:text-lg xl:text-xl text-slate-900 dark:text-slate-200 leading-relaxed font-medium'>
            We're a global team of advisors, consultants, engineers, scientists and creatives.
            Our thinking lives in code, in products and in market. We don't just create blueprints,
            operating models and business
            plans – we bend the mold until we discover the best solutions for your most complex challenges.

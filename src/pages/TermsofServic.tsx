            ...
            <div className="relative z-10">
                <div className="max-w-3xl mx-auto px-4 py-10 text-slate-800 dark:text-slate-300">
                    ...
                    <div className="mb-8">
                        <h2 className="text-xl font-semibold mb-2 text-slate-900 dark:text-slate-200">Intellectual Property</h2>
                        <p>
                            All software, content, graphics, and branding on this site remain the property of Cynerza or its licensors. Do not copy, reuse, or distribute Cynerza's technology or trademarks without permission.
                        </p>
                    </div>

    ...
    <div className="relative pt-24 md:pt-28 w-full px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 min-h-screen">
        ...
        <section className="relative py-10 transition-colors duration-500 overflow-hidden">
          ...
          {/* Decorative elements */}
          <div className="absolute top-0 left-0 w-72 h-72 bg-purple-300/30 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
          <div className="absolute top-0 right-0 w-72 h-72 bg-indigo-300/30 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
          <div className="absolute bottom-0 left-1/2 w-72 h-72 bg-purple-400/30 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000"></div>
        </section>
              ...
              >
                <div className="relative">
                  <img
                    ...
                    className="rounded-xl shadow-xl"
                  />
                  <div className="absolute -bottom-5 -right-5 dark:text-slate-200 text-slate-900 bg-white dark:bg-black p-4 rounded-xl shadow-lg">
                    <div className="flex items-center">
                      <div className="bg-green-100 p-2 rounded-full mr-3">
                        <MdGroups className="text-2xl text-green-600" />
                      </div>
          ...
          <div className="container mx-auto px-4 md:px-6">
              ...
              >
                {["All", ...departments].map(dept => (
                  <button
                    ...
                    className={`px-5 py-2 rounded-full font-medium transition-all duration-300 ${selectedDepartment === dept
                      ? 'bg-indigo-600 text-white shadow-md'
                      : 'bg-white/50 dark:bg-gray-800/50 text-gray-700 hover:bg-white/70 dark:text-gray-300 dark:hover:bg-gray-700/70 backdrop-blur-sm'
                      }`}
                    onClick={() => setSelectedDepartment(dept)}
                  >
                    {dept}
            ...
            {!jobPositions.length ? (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl max-w-md mx-auto">
                  <div className="bg-gray-200 p-3 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                    <MdWork className="text-3xl text-gray-600" />
                  </div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-slate-200 mb-2">No positions available</h3>
              ...
              <div className="max-w-4xl mx-auto">
                ...
                >
                  {filteredJobs.map((job) => (
                    <motion.div
                      key={job._id}
                      className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm dark:border-gray-700 rounded-xl border border-white/20 hover:shadow-md transition-all duration-300 overflow-hidden"
                      initial={{ opacity: 0, y: 20 }}
                      whileInView={{ opacity: 1, y: 0 }}
                      transition={{ duration: 0.5 }}
                      viewport={{ once: true }}
              ...
              >
                ...
                <div className="flex flex-col lg:flex-row gap-4">
                  ...
                  <motion.button
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="bg-white/50 hover:bg-white/70 backdrop-blur-sm text-slate-700 dark:text-slate-200 font-semibold py-3 px-8 rounded-full shadow-lg transition-colors duration-300 flex items-center justify-center gap-2"
                  >
                    Learn About Our Culture
                  </motion.button>
                </div>
